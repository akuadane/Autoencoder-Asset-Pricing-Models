...
from models.CA import CA0, CA1, CA2, CA3, CA3_1, CA3_2, CA3_A_1, CA3_1_Full, CA3_2_Full, CA3_Auto_1, CA3_fixed_1
...
def model_selection(model_type, model_K, omit_char=[]):
    assert model_type in ['FF', 'PCA', 'IPCA', 'CA0', 'CA1', 'CA2', 'CA3','CA3_1','CA3_2','CA3_1_Full','CA3_2_Full','CA3_Auto_1', 'CA3_A_1','CA3_fixed_1'], f'No Such Model: {model_type}'
    ...
    elif model_type=='CA3_A_1':
        return {
            'name': f'CA3_A_1_{model_K}',
            'omit_char': omit_char,
            'model': CA3_A_1(hidden_size=model_K, dropout=CA_DR, lr=CA_LR, omit_char=omit_char,device=DEVICE)
        }
    elif model_type=='CA3_fixed_1':
        return {
            'name': f'CA3_fixed_1_{model_K}',
            'omit_char': omit_char,
            'model': CA3_fixed_1(hidden_size=model_K, dropout=CA_DR, lr=CA_LR, omit_char=omit_char,device=DEVICE)
        }

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--Model', type=str, default='FF PCA IPCA CA0 CA1 CA2 CA3 CA3_1 CA3_2 CA3_1_Full CA3_2_Full CA3_Auto_1 CA3_A_1 CA3_fixed_1')
